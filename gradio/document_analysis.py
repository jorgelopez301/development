...
With a hig degree of confidence, I can say John Doe is being invoiced.
...
def chat_fn(multimodal_message):
    ...
    for token in client.chat_completion(messages=[system_message, user_message], max_tokens=100, stream=True, model="HuggingFaceH4/zephyr-7b-beta"):
...
with gr.Blocks() as demo:
    ...
    chat = gr.MultimodalTextbox(file_types=["image"], interactive=True, show_label=False, 
                                placeholder="Upload a document image by clicking '+' and ask a question")
